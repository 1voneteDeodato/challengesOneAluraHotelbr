...
public class RegistroHospede extends JFrame {
	...
	private HospedeControlador hospedesControl;
	...
	public RegistroHospede(int idReserva) {
		...
		this.hospedesControl = new HospedeControlador();
		...
		private void guardarHospedes() {
			...
			if(txtDataNascimento.getDate( != null && ! txtNome.equals(" ") && ! txtSobrenome.equals("") && ! txtTelefone.equals("")){
				...
				Hospedes hospedes = new Hospedes(txtNome.getText(), txtSobrenome.getText(), dataNascimento, txtNacionalidade.getSelectedItem().toString(), txtTelefone.getText(), Nreserva);
				
				this.hospedesControl.guardar(hospedes);
