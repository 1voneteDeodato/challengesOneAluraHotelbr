...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		TxtDataEntrada txtDataE = new JDateChooser();
	...
	private void guardarReserva() {
		...
		if(txtDataEntrada.getDate() != null && txtDataSaida.getDate() != null && !txtValor.equals("")
				&& !txtFormaPagamento.getSelectedItem().toString().equals("")) {
			LocalDate dataEntrada = LocalDate.parse(((JTextField)txtDataEntrada.getDateEditar().getUiComponent().getText());
			LocalDate dataSaida = LocalDate.parse(((JTextField)txtDataSaida.getDateEditar().getUiComponent().getText());
			reservas reservas = new reservas (dataEntrada, dataSaida, txtValor.getText(), txtFormaPagamento.getSelectedItem().toString());
			reservasControlador.guardar(reservas);
			
			RegistroHospede registro = new RegistroHospede(reservas.getId());
			registro.setVisible(true);
			dispose();
			
		} else {
				JOptionPane.showConfirmDialog(this, "Todos os campos");	
		}
	}
	
	public void calcularValor(JDataChooser dataEntrada, JDatachooser dataSaida) {
		
		if(dataEntrada.getDate() != && dataSaida.getDate() != null) {
			
			if(dataEntrada.getDate().after(dataS.getDate())) {
				JOptionPane.showMessageDialog(null, "Entrada e saida", "Error na saída", JOptionPane.ERROR_MESSAGE);
			...
			Calendar fin = dataSaida.getCalendar();
	...
	public void calcularValor(JDatechooser dataEntrada, JDatechooser dataSaida) {
